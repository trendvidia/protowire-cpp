...
void SetTimestampFields(google::protobuf::Message* msg, int64_t seconds,
                        int32_t nanos);
void SetDurationFields(google::protobuf::Message* msg, int64_t seconds,
                       int32_t nanos);

// Reads seconds + nanos from a Timestamp / Duration message.
void ReadTimestampFields(const google::protobuf::Message& msg, int64_t* seconds,
                         int32_t* nanos);
void ReadDurationFields(const google::protobuf::Message& msg, int64_t* seconds,
                        int32_t* nanos);
...
bool SetBigIntFromString(google::protobuf::Message* msg,
                         std::string_view literal);
bool SetDecimalFromString(google::protobuf::Message* msg,
                          std::string_view literal);
bool SetBigFloatFromString(google::protobuf::Message* msg,
                           std::string_view literal);
...
const google::protobuf::FieldDescriptor* FindNullMaskField(
...
std::vector<std::string> ReadNullPaths(
    const google::protobuf::Message& root,
    const google::protobuf::FieldDescriptor* null_mask_fd);
