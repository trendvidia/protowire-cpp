...
TEST(RFC3339, FormatRoundTrip) {
  ...
  EXPECT_EQ(FormatRFC3339Nano(1705314600, 123000000), "2024-01-15T10:30:00.123Z");
  EXPECT_EQ(FormatRFC3339Nano(1705314600, 123456789), "2024-01-15T10:30:00.123456789Z");
}
